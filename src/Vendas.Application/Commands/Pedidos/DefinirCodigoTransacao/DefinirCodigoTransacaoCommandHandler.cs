...
{
    public sealed class DefinirCodigoTransacaoCommandHandler
        : IRequestHandler<DefinirCodigoTransacaoCommand>
    {
        private readonly IPedidoRepository _pedidoRepository;
        private readonly IUnitOfWork _unitOfWork;

        public DefinirCodigoTransacaoCommandHandler(
        ...
        public async Task Handle(
            DefinirCodigoTransacaoCommand request,
