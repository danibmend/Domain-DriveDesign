    ...
    */
    internal sealed class PedidoRepository : IPedidoRepository
    {
        ...
        */
        ...
        {
            // Verificamos se o objeto já está sendo rastreado pelo EF.
            // Se não estiver (ex: veio de um cache ou outra fonte), nós o "anexamos".
            ...
            // Se já está sendo rastreado (Tracked), não fazemos NADA.
            // O EF já sabe o que mudou. Isso NÃO fere o SOLID pois a 
            // responsabilidade de "marcar para atualização" foi cumprida.
        }
    }
}
